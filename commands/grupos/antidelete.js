...
export default {
  ...
  groupOnly: true,
  adminOnly: true,
  description: "Reenvia mensagens borrados en grupos",
  ...
  async run({ sock, msg, from, args = [] }) {
    ...
    if (action === "on") {
      ...
      return sock.sendMessage(
        from,
        {
          text: "Antidelete ativado para este grupo.",
          ...global.channelInfo,
        },
        quoted
      );
    ...
    if (action === "off") {
      ...
      return sock.sendMessage(
        from,
        {
          text: "Antidelete desativado para este grupo.",
          ...global.channelInfo,
        },
        quoted
      );
