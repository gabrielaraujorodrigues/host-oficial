...
const STOPWORDS = new Set([
  ...
  "sen", "que", "se", "es", "un", "una", "unos", "unas", "lo", "al", "del",
  "a", "e", "i", "no", "se", "ya", "yo", "tu", "te", "mi", "me", "su", "sus",
  "le", "les", "como", "cuando", "donde", "porque", "pero", "mas", "muito",
  "the", "and", "for", "with", "you", "your", "this", "that", "from", "have",
  "has", "was", "were", "are", "they", "them", "just", "about", "olá", "jaja",
]);
...
export default {
  ...
  category: "ia",
  description: "Resume conversacion reciente del grupo con analises rápido",
  groupOnly: true,
  ...
  run: async ({ sock, msg, from, args = [], settings }) => {
    ...
    return sock.sendMessage(
      from,
      {
        text:
          `╭━━━〔 🧠 RESUMEN DE CHAT 〕━━━⬣\n` +
          `┃ Mensagens analizados: *${summary.count}*\n` +
          `┃ Rango: *${summary.range}*\n` +
          `╰━━━━━━━━━━━━━━━━━━━━━━⬣\n\n` +
          `👥 *Mas ativos*\n${participantText}\n\n` +
          `🏷️ *Temas detectados*\n${keywordText}\n\n` +
