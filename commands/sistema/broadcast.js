...
export default {
  ...
  category: "sestema",
  description: "Envia uma mensagem global para grupos ou privados",
    ...
    if (!text) {
      return sock.sendMessage(
        from,
        {
          text:
            "*USO DO BROADCAST*\n\n" +
            ".broadcast all mensagem\n" +
            ".broadcast grupos mensagem\n" +
            ".broadcast privados mensagem",
          ...global.channelInfo,
        },
        getQuoted(msg)
      );
